const TIMELINE = [
  ...
  },
  {
    ...
    text: 'Приобретён земельный участок под строительство индустриального парка «Бородино». Начало проектирования производственного комплекса полного цикла.',
    color: '#7c3aed',
    icon: '🏗️',
  },
  {
    ...
    text: 'Плановый запуск флагманского объекта ВПК: общая площадь 43 000 м², 8 000 м² производства, линия 60 000 банок в час, склады прямой отгрузки в сети, ответственное хранение и фулфилмент для маркетплейсов.',
    color: '#0891b2',
    icon: '🌆',
  },
];
