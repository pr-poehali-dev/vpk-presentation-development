const TIMELINE = [
  ...
  {
    year: '2025',
    title: 'Земля под Бородино',
    text: 'Куплена земля под строительство индустриального парка «Бородино». Начало проектирования: 8 000 м² производственных площадей, склады прямой отгрузки в сети и ответственного хранения, фулфилмент для маркетплейсов.',
    tag: 'Стратегия',
    color: '#8B5CF6',
    side: 'left',
    icon: '🏗️',
  ...
  {
    year: '2026',
    title: 'Индустриальный парк «Бородино»',
    text: 'Запуск флагманского объекта ВПК: производственная линия 60 000 банок в час, склады с прямой отгрузкой в федеральные сети, склады ответственного хранения и полный цикл фулфилмента для маркетплейсов.',
    tag: 'Будущее',
    color: '#00FFFF',
    side: 'right',
    icon: '🌆',
