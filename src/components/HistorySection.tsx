const TIMELINE = [
  ...
  },
  {
    ...
    text: 'Запуск флагманского объекта ВПК: общая площадь 43 000 м², 8 000 м² производства, линия 60 000 банок в час, склады прямой отгрузки в сети, ответственное хранение и фулфилмент для маркетплейсов. Логистика: Вязьма — Москва 210 км, до Минска 280 км, до Санкт-Петербурга 560 км. Удобный выход на трассу М1 «Беларусь».',
    color: '#0891b2',
    icon: '🌆',
  },
];
